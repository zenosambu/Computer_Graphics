...
xcopy /q /s head "%TEMP%.\cs_c3100_submit\head\"
...
xcopy /q assignment6001.dat %TEMPDIR%
xcopy /q pshader.glsl %TEMPDIR%
xcopy /q vshader.glsl %TEMPDIR%
...
CScript %SCRIPTFILE% %TEMPDIR% assignment6.zip
